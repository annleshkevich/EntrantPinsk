...
namespace EntrantPinsk.BusinessLogic.Services.Implementations
{
    public class InstitutionService : IInstitutionService
    {
        ...
        {
            return _mapper.Map<List<InstitutionDto>>(_db.EducationalInstitutions.AsNoTracking().ToList());
        }
        public InstitutionDto Get(int id)
        {
            return _mapper.Map<InstitutionDto>(_db.EducationalInstitutions.FirstOrDefault(u => u.Id == id)!);
        }
    }
}
